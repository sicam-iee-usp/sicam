...
"1", "25/10/2021", "15:40",  "G01-021-I0137", "Candidatos Pela Vida: Mortes Indígenas Estimulam A Participação Política De Povos Nativos?", "Matheus Valentim; Fernando Postali", "Em breve",
...
```{r}
  reactable::reactable(programacao_dia_1, pagination = FALSE,  columns = list(
    `Título` = colDef(minWidth = 200, html = TRUE) ,
