...
<a href="https://drive.google.com/file/d/1UZ1RYDjsdxoD_5uJsMUq3t3NJxejq4O3/view" target="_blank"><button type="button" class="btn btn-success">Clique aqui para baixar o modelo em word </button>
...
<a href="https://forms.gle/sew1gi3Bojd2RVEu7GClnlsk/view" target="_blank"><button type="button" class="btn btn-success">Acesse o formulário de inscrição e submissão! </button>
