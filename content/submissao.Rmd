...
O resumo expandido deverá conter até **3000 palavras** (excluindo as referências, figuras, tabelas, resumo e abstract), ressaltando a importância e justificativa do trabalho, o objetivo, o local de realização, a metodologia utilizada, os principais resultados e, ao final, a principal conclusão, escritos de maneira clara, coerente e concisa. O conteúdo deve apresentar coerência metodológica.
...
Todos os tópicos (Resumo, Introdução , entre outros) deverão ser escritos em letras maiúsculas e em negrito, seguidos por dois pontos (:) e pelo texto, com início na mesma linha. O recuo do parágrafo deve ser de 1,25 cm. Os tópicos devem ser separados do final do texto anterior por por um ENTER, com espaçamento de 1,5 cm entre as linhas. **Não colocar o número das páginas** no arquivo.
...
Para facilitar a formatação dos trabalhos pelos autores, a Comissão Organizadora do 3º SICAM também disponibilizou um modelo, em word:

<center> <a href="https://drive.google.com/file/d/1Y7mt43eXgG7e9-5mZGquhP4MtGClnlsk/view" target="_blank"><button type="button" class="btn btn-success">Clique aqui para baixar o modelo em word </button></center></a>
...
O **Título** deve ser redigido em fonte Times New Roman, tamanho 12, em negrito, centralizado. Todas as letras do título devem ser maiúsculas.
...
Ambos os arquivos devem ser anexados ao formulário de Inscrição [neste link](https://forms.gle/sew1gi3Bojd2RVEu7) até às 23h59min do dia 22 de agosto de 2021. A data de publicação dos aceites e anais será disponibilizada no [site do evento](https://sicam.com.br/).
...
A inscrição no evento (de 26/07 a 08/10 para autores que apresentarão trabalhos) poderá ser feita após o resultado do parecer do trabalho submetido, que ocorrerá até o dia 04/10/2021. **O autor responsável pela apresentação deverá se inscrever no evento**. Caso o autor responsável pela apresentação tenha algum imprevisto e não possa participar do evento, o mesmo deverá solicitar que outro autor faça a inscrição para a apresentação ou deverá informar à Comissão Organizadora que o trabalho não será apresentado. 



Em relação aos slides para as apresentações orais e vídeo-pôsteres, os autores podem utilizar a formatação de sua preferência, podendo incluir os logotipos do evento disponíveis para download no site (link). Posteriormente, será disponibilizado um tutorial para os vídeo-painéis no site do evento.
