...
-   No site do Simpósio (<https://sicam.com.br/>), serão disponibilizadas informações e tutoriais para apoiar a apresentação ao vivo dos trabalhos e a edição e envio de vídeo-pôster pelos autores. Em relação aos slides para as apresentações orais e vídeo-pôsteres, os autores podem utilizar a formatação de sua preferência, podendo incluir  o logotipo do evento [(disponível para download neste link: ](https://sicam.netlify.app/img/Logo_cor.png) https://sicam.netlify.app/img/Logo_cor.png ).
